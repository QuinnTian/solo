<footer class="footer">
  <div class="fn-clear">
    ...
    <span class="fn-right">&nbsp;
	<a style="text-decoration: none;" href="http://sdcainfo.miitbeian.gov.cn">鲁ICP备18015901号  </a><a rel="nofollow" href="http://sdcainfo.miitbeian.gov.cn" target="_blank"><img src="http://p95x8s7hh.bkt.clouddn.com/ghs.png" width="12px" height="12px" alt="通信管理局备">山东省通信管理局</a>
	</span>
  ...
  <div class="fn-clear">
    ...
    <span class="fn-right">&nbsp;
      ...
      <a href="https://cloud.tencent.com/" lang="托管于腾讯云." class="itip" id="aly" rel="nofollow"><span class="fa fa-skyatlas fa-1x"></span></a>
      <a href="https://cloud.tencent.com" lang="存储于七牛云." class="itip" id="qny" rel="nofollow"><span class="iconfont icon-qiniu1"></span></a>&nbsp; 
      
      Powered by <a href="http://b3log.org" rel="friend">B3log开源·Solo</a>
      <a rel="friend" href="https://zixizixi.cn/"></a>
    </span>
  </div>
